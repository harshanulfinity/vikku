    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="glass-strong rounded-2xl p-8 text-center mt-8 print:hidden">
          <h3 className="font-display font-semibold text-lg mb-3">Want this built for you?</h3>
          <p className="text-white/60 text-sm mb-6 max-w-md mx-auto">Vikku designs and ships software, websites, and apps. Get a free consultation.</p>
          <button onClick={() => navigate('/')} className="bg-white text-black font-semibold px-8 py-3 rounded-xl hover:bg-white/90 transition-colors inline-flex items-center gap-2">
